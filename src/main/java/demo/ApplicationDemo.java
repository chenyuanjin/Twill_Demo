 ...
 *这个demo展示了TwillApplication接口,将应用接入YARN,相比集成AbstractTwillRunnable类,配置更加灵活
 */

public class ApplicationDemo {

    public static final Logger logger = LoggerFactory.getLogger(ApplicationDemo.class);
    public static class TwillApplicationDemo  implements TwillApplication {
        @Override
        public TwillSpecification configure() {
            ...
            TwillRunnable runnable = new TwillRunnableDemo();
            return TwillSpecification.Builder.with()
                    .setName("TwillTestApplication")
                    .withRunnable()
                    .add(runnable,rs)
                    .noLocalFiles()
                    .anyOrder()
    ...
    public static void main(String[] args) {
        ...
        final TwillController controller = twillRunner.prepare(new TwillApplicationDemo())
